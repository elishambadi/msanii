      ...
      <div class="container-fluid" style="text-align: center">
        ...
        <div class="col-md-4">
          ...
          <?php 
            ...
            //Display a table of all the bookings
            //Ideal statement
            // $sql = "SELECT * FROM bookings WHERE (photographer_id = '$photographer_id' || model_id = '$model_id')";

            //Test statement
            $sql = "SELECT * FROM bookings WHERE (photographer_id = '1')";
            ...
            if ($result -> num_rows > 0) {
              ...
              while ($row = $result -> fetch_assoc()) {
                ...
                echo "<td>";
                $sql1 = "SELECT location_name FROM location WHERE (location_id = ".$row["location_id"].")";
                $resultLoc = $conn -> query($sql1);
                ...
                echo "<td>";
                $sql2 = "SELECT username FROM photographers WHERE (photographer_id = ".$row["photographer_id"].")";
                $resultPhoto = $conn -> query($sql2);

                if ($resultPhoto -> num_rows > 0) {
                  while ($row1 = $resultPhoto -> fetch_assoc()) {
                    echo $row1["username"];
                  }
                }
                echo "</td>";
                ...
                //Display model name
                echo "<td>";
                $sql3 = "SELECT username FROM models WHERE (model_id = ".$row["model_id"].")";
                $resultModel = $conn -> query($sql3);
